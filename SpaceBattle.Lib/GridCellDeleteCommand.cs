...
{
    public readonly List<IDictionary<string, object>>[] Grid;
    public readonly int x;
    public readonly int y;
    public readonly IDictionary<string, object> ship;
    public readonly int size_x;
    public readonly int size_y;
    public GridCellDeleteCommand(List<IDictionary<string, object>>[] Grid, int x, int y, IDictionary<string, object> ship, int size_x, int size_y)
    {
        this.Grid = Grid;
        this.x = x;
        this.y = y;
